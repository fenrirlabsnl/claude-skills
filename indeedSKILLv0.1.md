...
**Recommended model:** Claude Sonnet 4.6 (`claude-sonnet-4-6`) — balances speed and accuracy for browser automation and job extraction.
...
Stage 9: Display          →  Show results in structured format
```
...
- Technical role detection logic (exclude-only filtering)
